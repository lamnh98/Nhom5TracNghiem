...
public class Insertgrammarguidelinename extends HttpServlet {
			...
			throws ServletException, IOException 
	{
		...
		String grammar=request.getParameter("grammarname");
		
		Grammarguideline gmgl=new Grammarguideline();
		
		gmgl.setGrammarname(grammar);
		...
		try 
		{
			...
			if(kt)
			{
				int grammarguidelineid=GrammarguidelinemanageDAO.Retrieveidgrammarguideline(request, conn, gmgl);
