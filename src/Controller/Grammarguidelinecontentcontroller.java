...
public class Grammarguidelinecontentcontroller extends HttpServlet {
			...
			throws ServletException, IOException
	{
		...
		boolean kt=GrammarguidelinemanageDAO.Insertgrammarguidelinecontent(request, conn, gmgl,grammarguidelineid);
		...
		{
			request.setAttribute("msggrammarguidelinecontent","Thêm nội dung thất bại!!!");
