...
<head>
<meta charset="utf-8">
<title>Quan Ly De Thi Page</title>
				...
				<div class="main-content">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li class="active">Add List Exam</li>
						</ul><!-- .breadcrumb -->
					</div>
					<div class="page-content">
						<c:if test="${msgquanlydethi!=''}">
							<h4 class="pink">
									<i class="icon-hand-right icon-animated-hand-pointer blue"></i>
									<a href="#modal-table" role="button" class="green" data-toggle="modal">${msgquanlydethi}</a>
							</h4>
						</c:if>
						<div class="row">
							<div class="col-xs-12">
									...
									<div class="col-xs-12">
										<div class="table-responsive">
											<table id="sample-table-1" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<c:forEach items="${msglistexam}" var="l">
														<tr>
															<td class="center">
																${l.exeminationid}
															</td>
															...
															<td class="center">
																<a class="green" href="Themcauhoidethi?exeminationid=${l.exeminationid}">
			    ...
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			       	<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nhập Đề Thi </label>
	
						<div class="col-sm-9">
							<input type="text" id="form-field-1" placeholder="Tên bài hướng dẫn" class="col-xs-10 col-sm-5" name="examinationname" />
						</div>
					</div>
			      </div>
