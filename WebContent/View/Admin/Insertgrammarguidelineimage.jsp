							...
							<div class="widget-body">
								<div class="widget-main">
									<h4 class="header blue lighter bigger">
										...
										Add Image For Learning
									</h4>

									<div class="space-6"></div>

									<form action="Uploadgrammarguidelineimage?grammarguidelineid=<%=request.getAttribute("grammarguidelineid")%>"  enctype="multipart/form-data"  method="POST">
										<fieldset>
											<label class="block clearfix" style="color:red">
											<%=request.getAttribute("msgGrammarguidelineimage")!=null?request.getAttribute("msgGrammarguidelineimage"):" " %>
											</label>
